...
func (app *application) addDefaultData(td *tempData, r *http.Request) *tempData {
	return td
}

func (app *application) renderTemplate(w http.ResponseWriter, r *http.Request, page string, td *tempData, partials ...string) error {
